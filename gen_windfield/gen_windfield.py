...
from maputils import bearing2theta, makeGrid

import nctools as nctools
...
def run(input_track_file, callback=None):
    """
    ...
    track_data = track.readTrackData(input_track_file)
    print(track_data)
